...
video_capture = cv2.VideoCapture("C:/Users/pc/Downloads/output1/test_vid2_orig.avi")
#video_capture = cv2.VideoCapture("E:/pc/Pictures/Camera Roll/1.mp4")
writer = None
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter("outVideo.mp4", fourcc, 25,(frame.shape[1], frame.shape[0]), True)
